    ...
    <section id="share" className="py-24 px-6">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <div className="mt-12 mb-8">
          <p className="font-mono mb-4" style={{ fontSize: 11, letterSpacing: '.12em', color: 'rgba(96,165,250,.55)', textTransform: 'uppercase' }}>
            Wuque Studio
          </p>
          <div className="flex flex-wrap gap-2.5 justify-center">
            {wuqueLinks.map(l => (
              ...
              >
                <span style={{ opacity: .7 }}>{l.icon}</span>
                <span>{l.label}</span>
                <span className="font-mono" style={{ fontSize: 10, color: 'rgba(96,165,250,.4)' }}>{l.sub}</span>
              </a>
            ))}
          </div>
        </div>
        ...
        {/* Ko-fi support block */}
        <div
            className="mt-4 mb-10 rounded-xl px-6 py-5 flex flex-col items-center gap-3"
        ...
        <p className="mt-8 text-xs font-mono" style={{ color: 'rgba(100,116,139,.35)' }}>
